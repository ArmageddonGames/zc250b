...
public:
	...
	virtual void caseProgram(ASTProgram &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseFloat(ASTFloat &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseString(ASTString &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseDeclList(ASTDeclList &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseImportDecl(ASTImportDecl &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseConstDecl(ASTConstDecl &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseFuncDecl(ASTFuncDecl &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseArrayDecl(ASTArrayDecl &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseArrayList(ASTArrayList &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseTypeFloat(ASTTypeFloat &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseTypeBool(ASTTypeBool &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseTypeVoid(ASTTypeVoid &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	...
	virtual void caseExprAnd(ASTExprAnd &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprOr(ASTExprOr &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprGT(ASTExprGT &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprGE(ASTExprGE &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprLT(ASTExprLT &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprLE(ASTExprLE &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprEQ(ASTExprEQ &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprNE(ASTExprNE &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprPlus(ASTExprPlus &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprMinus(ASTExprMinus &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprTimes(ASTExprTimes &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprDivide(ASTExprDivide &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprNot(ASTExprNot &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprArrow(ASTExprArrow &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprArray(ASTExprArray &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprNegate(ASTExprNegate &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseNumConstant(ASTNumConstant &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseFuncCall(ASTFuncCall &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseBoolConstant(ASTBoolConstant &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseBlock(ASTBlock &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtAssign(ASTStmtAssign &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprDot(ASTExprDot &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtFor(ASTStmtFor &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtIf(ASTStmtIf &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtIfElse(ASTStmtIfElse &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtReturn(ASTStmtReturn &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtReturnVal(ASTStmtReturnVal &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtEmpty(ASTStmtEmpty &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseScript(ASTScript &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtWhile(ASTStmtWhile &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtDo(ASTStmtDo &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprBitOr(ASTExprBitOr &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprBitXor(ASTExprBitXor &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprBitAnd(ASTExprBitAnd &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprLShift(ASTExprLShift &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprRShift(ASTExprRShift &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprBitNot(ASTExprBitNot &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprIncrement(ASTExprIncrement &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprDecrement(ASTExprDecrement &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseExprModulo(ASTExprModulo &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtBreak(ASTStmtBreak &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/  caseDefault(param);}
	virtual void caseStmtContinue(ASTStmtContinue &host, void *param) {void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/ caseDefault(param);}
	virtual ~ASTVisitor() {}
};
...
{
public:
	ASTArrayDecl(ASTType *Type, string Name, ASTFloat *Size, ASTArrayList *List, LocationData Loc) :
	ASTDecl(Loc), name(Name), list(List), size(Size), type(Type) {}
	ASTType *getType() {return type;}
	string getName() {return name;}
	ASTFloat *getSize() {return size;}
	ASTArrayList *getList() {return list;}
	~ASTArrayDecl();
	void execute(ASTVisitor &visitor, void *param)
	{
...
{
public:
	ASTArrayList(LocationData Loc) : AST(Loc) {}
	~ASTArrayList();
	list<ASTFloat *> &getList() {return values;}
	void addParam(ASTFloat *value);
	void execute(ASTVisitor &visitor, void *param)
	{
		visitor.caseArrayList(*this,param);
	}
private:
	list<ASTFloat *> values;
	//NOT IMPLEMENTED; DO NOT USE
...
public:
	...
	string getName() {return name;}
	string getNamespace() {return nspace;}
	~ASTExprArray() {if(index) delete index;}
	void execute(ASTVisitor &visitor, void *param)
	{
...
public:
	...
	ASTStmt *getStmt() {return stmt;}
	virtual ~ASTStmtIf() {delete cond; delete stmt;}
	void execute(ASTVisitor &visitor, void *param)
	{
...
public:
	...
	~ASTStmtDo() {delete cond; delete stmt;}
	ASTExpr *getCond() {return cond;}
	ASTStmt *getStmt() {return stmt;}
	void execute(ASTVisitor &visitor, void *param)
	{
