...
public:
	...
	virtual void caseArrayList(ASTArrayList &host, void *param);
...
{
public:
	virtual void caseDefault(void *param) { param=param; /*these are here to bypass compiler warnings about unused arguments*/ *(bool *)param = false; }
	virtual void caseFuncDecl(ASTFuncDecl &host, void *param) { void *temp; temp=&host; param=param; /*these are here to bypass compiler warnings about unused arguments*/ *(bool *)param = true; }
};
