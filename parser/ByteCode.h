...
#define DMAPFLAGSD			301 //512 of these
...
class OPtrOffRegister : public UnaryOpcode
{
public:
	OPtrOffRegister(Argument *A) : UnaryOpcode(A) {}
	string toString();
	Opcode *clone() {return new OPtrOffRegister(a->clone());}
};
...
class ODeclare : public Opcode
{
public:
	string toString();
	Opcode *clone() {return new ODeclare();}
};
