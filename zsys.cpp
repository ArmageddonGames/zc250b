...
// Don't free() the passed tempname... -L
char *temp_name(char *s)
{
  int tempnum;
  static char *temporaryname;
  if (!temporaryname)
    temporaryname=(char*)malloc(L_tmpnam);
...
//char zeldapwd[8]  = { 'G'+11,'i'+22,'g'+33,'i'+44,'2'+55,'0'+66, 0 +77,'c'+88 };
//char zeldapwd[8]  = { 'T'+11,'e'+22,'m'+33,'e'+44,'n'+55,'k'+66,'u'+77, 0 +88 };
//char zeldapwd[8]  = { 'T'+11,'a'+22,'n'+33,'g'+44,'a'+55,'n'+66, 0 +77,0+88 };
char zeldapwd[8]  = { 'N'+11,'0'+22,'S'+33,'7'+44,'1'+55,'M'+66,'3'+77, 0 +88 };
...
char zquestpwd[8] = { 'S'+11,'3'+22,'('+33,'r'+44,'3'+55,'7'+66,'!'+77, 0 +88 };
...
{
  int count=0;
  for (count=1; from[count].proc!=NULL; ++count) { /* do nothing */ }
  ...
  for (int i=0; i<count; ++i)
  {
    if ((from[i].dp!=NULL)&&
       ((from[i].proc==d_alltriggerbutton_proc)||
        ...
        (from[i].proc==dcs_auto_button_proc)||
...
{
  int count=0;
  for (count=1; (*dlg)[count].proc!=NULL; ++count) { /* do nothing */ }
  for (int i=0; i<count+1; ++i)
  {
    if (((*dlg)[i].dp!=NULL)&&
       (((*dlg)[i].proc==d_alltriggerbutton_proc)||
        ...
        ((*dlg)[i].proc==dcs_auto_button_proc)||
