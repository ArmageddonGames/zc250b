...
class LinkClass : public sprite
{
	...
	public:
		...
		int getHopClk() {return newhopclk;}
		int getDir() {return newdir;}
		int getLadderdir() {return newladderdir;}
		int getLadderx() {return newladderx;}
		int getLaddery() {return newladdery;}
		int getLadderstart() {return newladderstart;}
		...
		bool isUnwalkable() {return (flags & UNWALKABLE) != 0;}
  ...
  bool autostep,superman,refilling,inwallm,tapping,stomping,last_hurrah;
  int ladderx,
      laddery,
