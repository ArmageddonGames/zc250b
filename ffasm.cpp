...
{  //name                id                maxcount       multiple
  ...
  { "SCREENSTATE",       SCREENSTATE(0),      32,             0 },
  ...
  { "LWPNMISC",               LWPNMISC(0),               16,             0 },
  { "EWPNMISCD",              EWPNMISCD,                  0,             0 },
  { "EWPNMISC",               EWPNMISC(0),               16,             0 },
  { "NPCMISCD",               NPCMISCD,                   0,             0 },
  { "NPCMISC",                NPCMISC(0),                16,             0 },
  { "ITEMMISCD",              ITEMMISCD,                  0,             0 },
  { "ITEMMISC",               ITEMMISC(0),               16,             0 },
  { "FFMISCD",                FFMISCD,                    0,             0 },
  { "FFMISC",                 FFMISC(0),                 16,             0 },
  { "GETMIDI",                GETMIDI,                    0,             0 },
