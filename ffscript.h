...
//0x0245-0x0258 are reserved for future Link variables
...
#define LWPNMISC(n)        ((0x101D)+(n)) //16
#define EWPNMISCD            0x102D
#define EWPNMISC(n)        ((0x102E)+(n)) //16
#define NPCMISCD             0x103E
#define NPCMISC(n)         ((0x103F)+(n)) //16
#define ITEMMISCD            0x104F
#define ITEMMISC(n)        ((0x1050)+(n)) //16
#define FFMISCD              0x1060
#define FFMISC(n)          ((0x1061)+(n)) //16
...
#define SCREENFLAGS(n)     ((0x107C)+(n)) //10
#define SCREENEFLAGSD        0x1086
#define SCREENEFLAGS(n)    ((0x1087)+(n)) //3
#define FFINITDD		    0x108B
#define FFINITD(n)		  ((0x108C)+(n)) //8
#define LINKMISCD            0x1094
#define LINKMISC(n)        ((0x1095)+(n)) //16
#define DMAPFLAGSD		    0x10A5
//#define DMAPFLAGS(n)	  ((0x10A6)+(n)) //512
...
//#define FFDD			    0x10A8
//#define FFD(n)			  ((0x10A9)+(n)) //8

#define NUMVARIABLES         0x10A8
