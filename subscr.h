...
// counter objects
enum { sscRUPEES, sscBOMBS, sscSBOMBS, sscARROWS, sscGENKEYMAGIC, sscGENKEYNOMAGIC, sscLEVKEYMAGIC,
	  sscLEVKEYNOMAGIC, sscANYKEYMAGIC, sscANYKEYNOMAGIC, sscSCRIPT1, sscSCRIPT2, sscSCRIPT3, sscSCRIPT4,
	  sscSCRIPT5, sscSCRIPT6, sscSCRIPT7, sscSCRIPT8, sscSCRIPT9, sscSCRIPT10, sscMAX };
...
typedef struct subscreen_object
{
  byte  type;
  byte  pos;
  word  x;
...
typedef struct subscreen_group
{
  byte             ss_type;
  char             name[64];
