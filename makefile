...
ifdef COMPILE_FOR_WIN
  ...
  ZC_PLATFORM = Windows
  CC = g++
  CFLAG = $(CFLAGBASE) -Werror -pedantic -I./include/dumb/ -I./include/alogg/ -I./include/almp3 -I./include/lpng1212/ -I./include/loadpng/ -I./include/lpng1212/ -I./include/jpgalleg-2.5/ -I./include/zlib123/  -I./include/pthread/
  LIBDIR = -L./libs/mingw
else
...
ifdef COMPILE_FOR_MACOSX
  ...
  CFLAG = $(CFLAGBASE) -pedantic -I./include/dumb/ -I./include/alogg/ -I./include/almp3/ -I./include/libjpgal/
  CC = g++
  LIBDIR= -L./libs/osx
  DATA = output/common/
else
...
rv_icon.o: rv_icon.rc rv_icon.ico
	windres --use-temp-file -J rc -O coff -i rv_icon.rc -o rv_icon.o
...
zc_icon.o: zc_icon.rc zc_icon.ico
	windres --use-temp-file -J rc -O coff -i zc_icon.rc -o zc_icon.o
...
zq_icon.o: zq_icon.rc zq_icon.ico
	windres --use-temp-file -J rc -O coff -i zq_icon.rc -o zq_icon.o
