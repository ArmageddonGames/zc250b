  ...
  if (!d[0].d1)
  {
    ...
    for (int i=1; d[i].proc!=NULL; i++)
    {
      ...
      else if (d[i].proc == jwin_edit_proc || d[i].proc == jwin_check_proc || d[i].proc == jwin_checkfont_proc || d[i].proc == jwin_tflpcheck_proc || d[i].proc == jwin_lscheck_proc)
      {
		...
		|| d[i].proc == jwin_fontdrop_proc || d[i].proc == d_csl_proc || d[i].proc == d_csl2_proc || d[i].proc == d_stilelist_proc)
      {
...
static ItemNameInfo inameinf[]=
{
  ...
  { itype_magickey,                    (char *)"Dungeon Level (0 = All):",                  NULL,                                        NULL,                                      NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              (char *)"Lesser D. Levels Also",           NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL                                       },
  ...
  { itype_dinsfire,                    (char *)"Damage:",                         (char *)"Number of Flames:",                 (char *)"Circle Width:",                   NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                                      (char *)"Don't Provide Light",     NULL,                              NULL,                              NULL,                              (char *)"Rocket Up Sprite:",       (char *)"Rocket Down Sprite:",            (char *)"R. Up Sparkle Sprite:",             (char *)"R. Down Sparkle Sprite:",         NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      (char *)"Ring Sound:"                      },
  ...
  { itype_book,                        (char *)"Damage:",                         NULL,                                        NULL,                                      NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              (char *)"Fire Magic",                      NULL,                              NULL,                              NULL,                              NULL,                              (char *)"Magic Sprite:",           NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      (char *)"Firing Sound:"                    },
...
{
  // dialog control number
  179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, -1
};
...
static TABPANEL itemdata_tabs[] =
{
  ...
  { (char *)"Arguments",    0,             itemdata_scriptargs_list,    0, NULL },
  { NULL,                   0,             NULL,                        0, NULL }
};
...
static DIALOG itemdata_dlg[] =
{
  ...
  { jwin_edit_proc,         107,     62,     35,     16,    vc(12),                 vc(1),                   0,       0,           2,    0,  NULL,                                           NULL,   NULL                  },
  { jwin_text_proc,           8,     84,     60,      8,    vc(14),                 vc(1),                   0,       0,           0,    0,  (void *) "Full Max:",                           NULL,   NULL                  },
  ...
  //101
  { jwin_text_proc,           8,    102,     35,      8,    vc(14),                 vc(1),                   0,       0,           0,    0,  (void *) "Script:",                             NULL,   NULL                  },
  ...
  //131
  { jwin_text_proc,           8,     48,     35,      8,    vc(14),                 vc(1),                   0,       0,           0,    0,  (void *) "Script:",                             NULL,   NULL                  },
  { jwin_edit_proc,          55,     44,     28,     16,    vc(12),                 vc(1),                   0,       0,           3,    0,  NULL,                                           NULL,   NULL                  },
  { jwin_text_proc,          87,     48,     35,      8,    vc(14),                 vc(1),                   0,       0,           0,    0,  (void *) "Magic:",                              NULL,   NULL                  },
...
void edit_itemdata(int index)
{
  ...
  char /*cls[8],*/ cll[8], cnt[8], amt[8], fmx[8], max[8], asn[8];
  char scr[8], snd[8], csc[8], mgc[8], hrt[8], pow[8];
  ...
  sprintf(csc,"%d",itemsbuf[index].collect_script);
  ...
  itemdata_dlg[96].dp = cnt;
  itemdata_dlg[98].dp = fmx;
  itemdata_dlg[100].dp = max;
  itemdata_dlg[102].dp = csc;
...
//    itemdata_dlg[140+(i*2)].dp3 = is_large ? sfont3 : pfont;
  ...
  do
  {
    ...
    test.collect_script = vbound(atoi(csc), 0, 255);
    test.misc1  = atoi(ms1);
    test.misc2  = atoi(ms2);
    test.misc3  = atoi(ms3);
    test.misc4  = atoi(ms4);
    ...
    if(ret==5)
    {
      ...
      sprintf(fmx,"%d",test.max);
      sprintf(max,"%d",test.setmax);
      sprintf(scr,"%d",test.script);
      sprintf(snd,"%d",test.playsound);
      sprintf(csc,"%d",test.collect_script);
...
{
	153,154,155,156,157,158,159,160,170,171,172,173,174,175,176,177,-1
};
